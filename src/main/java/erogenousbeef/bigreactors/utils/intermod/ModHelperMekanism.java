...
public class ModHelperMekanism extends ModHelperBase {
	...
	public void register() {
		...
		ItemStack malloriteOre  = new ItemStack(BigReactors.blockMalloriteOre, 1);
		...
		ItemStack ingotMallorium = ingotGeneric.getItemStackForType("ingotMallorium");
		ItemStack ingotMixedReactant = ingotGeneric.getItemStackForType("ingotMixedReactant");
		...
		ItemStack dustMallorium = ingotGeneric.getItemStackForType("dustMallorium");
		ItemStack dustMixedReactant = ingotGeneric.getItemStackForType("dustMixedReactant");
		...
		if(ingotMallorium != null && dustMallorium != null) {
			addMekanismCrusherRecipe(ingotMallorium.copy(), dustMallorium.copy());
		}
		if(ingotMixedReactant != null && dustMixedReactant != null) {
			addMekanismCrusherRecipe(ingotMixedReactant.copy(), dustMixedReactant.copy());
		}
