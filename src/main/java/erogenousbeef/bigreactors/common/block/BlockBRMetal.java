...
public class BlockBRMetal extends Block {
	...
	public static final int METADATA_MALLORIUM = 5;
	public static final int METADATA_MIXEDREACTANT = 6;
	
	private static final String[] _subBlocks = new String[] { "blockYellorium", "blockCyanite", "blockGraphite", "blockBlutonium", "blockLudicrite", "blockMallorium", "blockMixedReactant"};
	private static final String[] _materials = new String[] { "Yellorium", "Cyanite", "Graphite", "Blutonium", "Ludicrite", "Mallorium", "MixedReactant"};
