...
{
	public static final String[] TYPES = { "ingotYellorium", "ingotCyanite", "ingotGraphite", "ingotBlutonium", "ingotMallorium",
											"dustYellorium", "dustCyanite", "dustGraphite", "dustBlutonium",
											"ingotLudicrite", "dustLudicrite", "dustMallorium", "ingotMixedReactant", "dustMixedReactant"};

	public static final String[] MATERIALS = { "Yellorium", "Cyanite", "Graphite", "Blutonium", "Ludicrite", "Mallorium", "MixedReactant"};
